...
import { Home, ShoppingCart, Package, MessageCircle, User, LayoutDashboard, Inbox, Heart, CreditCard, Pill } from 'lucide-react';
...
export type AdminLabelKey = 'dashboard' | 'verifications' | 'reports' | 'payments' | 'medicines';
